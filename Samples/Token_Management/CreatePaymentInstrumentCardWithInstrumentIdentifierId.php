...
function CreatePaymentInstrumentCardWithInstrumentIdentifierId($profileid)
{
	$cardArr = [
			"expirationMonth" => "09",
			"expirationYear" => "2017",
	...
	$instrumentIdentifier = new CyberSource\Model\TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedInstrumentIdentifier($instrumentIdentifierArr);
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nCreatePaymentInstrumentCardWithInstrumentIdentifierId Sample Code is Running..." . PHP_EOL;
	echo "\nInput missing header parameter <profile-id>: ";
	$profileid = trim(fgets(STDIN));
	CreatePaymentInstrumentCardWithInstrumentIdentifierId($profileid);
}
?>
