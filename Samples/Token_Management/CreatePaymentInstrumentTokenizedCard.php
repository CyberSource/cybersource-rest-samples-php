...
function CreatePaymentInstrumentTokenizedCard($profileid)
{
	$cardArr = [
			"expirationMonth" => "09",
			"expirationYear" => "2017",
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nCreatePaymentInstrumentTokenizedCard Sample Code is Running..." . PHP_EOL;
	echo "\nInput missing header parameter <profile-id>: ";
	$profileid = trim(fgets(STDIN));
	CreatePaymentInstrumentTokenizedCard($profileid);
}
?>
