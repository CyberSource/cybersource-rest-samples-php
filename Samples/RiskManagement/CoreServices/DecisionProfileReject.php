...
function DecisionProfileReject()
{
	...
	$riskInformation = new CyberSource\Model\Riskv1decisionsRiskInformation($riskInfo);
...
if(!defined('DO_NOT_RUN_SAMPLES')){
    echo "DecisionProfileReject Samplecode is Running.. \n";
