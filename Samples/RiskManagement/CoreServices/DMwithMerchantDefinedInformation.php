...
function DMwithMerchantDefinedInformation()
{
    ...
    $merchantInfo_1 = ["key" => "1", "value" => "Test"];
    $merchantInfo_2 = ["key" => "2", "value" => "Test2"];

    $merchantDefinedInformation = array();

    $merchantDefinedInformation[0] = new CyberSource\Model\Riskv1decisionsMerchantDefinedInformation($merchantInfo_1);
    $merchantDefinedInformation[1] = new CyberSource\Model\Riskv1decisionsMerchantDefinedInformation($merchantInfo_2);

	$reqObj = ["clientReferenceInformation" => $clientReferenceInformation, "paymentInformation" => $paymentInformation, "orderInformation" => $orderInformation, "merchantDefinedInformation" => $merchantDefinedInformation];
...
if(!defined('DO_NOT_RUN_SAMPLES')){
    echo "DMwithMerchantDefinedInformation Samplecode is Running.. \n";
