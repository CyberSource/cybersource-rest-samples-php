...
function DMwithTravelInformation()
{
    ...
    $legs_1 = ["origination" => "SFO", "destination" => "JFK"];
    $legs_2 = ["origination" => "JFK", "destination" => "BLR"];

    $legs = array();

    $legs[0] = new CyberSource\Model\Riskv1decisionsTravelInformationLegs($legs_1);
    $legs[1] = new CyberSource\Model\Riskv1decisionsTravelInformationLegs($legs_2);
    
    $travelInfo = ["completeRoute" => "SFO-JFK:JFK-BLR", "departureTime" => "2011-03-20 11:30pm GMT", "journeyType" => "One way", "legs" => $legs];

    $travelInformation = new CyberSource\Model\Riskv1decisionsTravelInformation($travelInfo);
...
if(!defined('DO_NOT_RUN_SAMPLES')){
    echo "DMwithTravelInformation Samplecode is Running.. \n";
