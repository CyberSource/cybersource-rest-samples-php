...
function ScoreExceedsThreshold()
{
	...
	$shipTo = new CyberSource\Model\Riskv1decisionsOrderInformationShipTo($shipTo);

	$orderInfo = ["amountDetails" => $amountDetails, "billTo" => $billTo, "shipTo" => $shipTo];
...
if(!defined('DO_NOT_RUN_SAMPLES')){
    echo "ScoreExceedsThreshold Samplecode is Running.. \n";
