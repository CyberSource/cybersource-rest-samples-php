...
function ProcessPaymentSimpleAuthorizationRetail()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nProcessPaymentSimpleAuthorizationRetail Sample Code is Running..." . PHP_EOL;
	ProcessPaymentSimpleAuthorizationRetail();
}
?>
