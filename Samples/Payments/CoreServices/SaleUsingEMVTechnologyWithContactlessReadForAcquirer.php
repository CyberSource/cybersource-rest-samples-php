...
function SaleUsingEMVTechnologyWithContactlessReadForAcquirer()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nSaleUsingEMVTechnologyWithContactlessReadForAcquirer Sample Code is Running..." . PHP_EOL;
	SaleUsingEMVTechnologyWithContactlessReadForAcquirer();
}
?>
