...
function SaleUsingEMVTechnologyWithContactReadTwoForAcquirer()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nSaleUsingEMVTechnologyWithContactReadTwoForAcquirer Sample Code is Running..." . PHP_EOL;
	SaleUsingEMVTechnologyWithContactReadTwoForAcquirer();
}
?>
