...
function ProcessPaymentWithNetworkTokenization()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nProcessPaymentWithNetworkTokenization Sample Code is Running..." . PHP_EOL;
	ProcessPaymentWithNetworkTokenization();
}
?>
