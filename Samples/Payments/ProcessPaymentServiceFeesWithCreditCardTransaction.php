...
function ProcessPaymentServiceFeesWithCreditCardTransaction()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nProcessPaymentServiceFeesWithCreditCardTransaction Sample Code is Running..." . PHP_EOL;
	ProcessPaymentServiceFeesWithCreditCardTransaction();
}
?>
