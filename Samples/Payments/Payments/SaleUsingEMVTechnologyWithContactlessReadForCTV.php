...
function SaleUsingEMVTechnologyWithContactlessReadForCTV()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nSaleUsingEMVTechnologyWithContactlessReadForCTV Sample Code is Running..." . PHP_EOL;
	SaleUsingEMVTechnologyWithContactlessReadForCTV();
}
?>
