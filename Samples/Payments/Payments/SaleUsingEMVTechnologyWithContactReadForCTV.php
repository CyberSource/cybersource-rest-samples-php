...
function SaleUsingEMVTechnologyWithContactReadForCTV()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nSaleUsingEMVTechnologyWithContactReadForCTV Sample Code is Running..." . PHP_EOL;
	SaleUsingEMVTechnologyWithContactReadForCTV();
}
?>
