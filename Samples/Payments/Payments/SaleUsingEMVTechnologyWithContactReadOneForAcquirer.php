...
function SaleUsingEMVTechnologyWithContactReadOneForAcquirer()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nSaleUsingEMVTechnologyWithContactReadOneForAcquirer Sample Code is Running..." . PHP_EOL;
	SaleUsingEMVTechnologyWithContactReadOneForAcquirer();
}
?>
