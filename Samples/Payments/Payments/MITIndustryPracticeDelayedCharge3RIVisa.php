...
function MITIndustryPracticeDelayedCharge3RIVisa()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nMITIndustryPracticeDelayedCharge3RIVisa Sample Code is Running..." . PHP_EOL;
    MITIndustryPracticeDelayedCharge3RIVisa();
}
?>