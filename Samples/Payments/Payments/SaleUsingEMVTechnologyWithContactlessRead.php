...
function SaleUsingEMVTechnologyWithContactlessRead()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nSaleUsingEMVTechnologyWithContactlessRead Sample Code is Running..." . PHP_EOL;
	SaleUsingEMVTechnologyWithContactlessRead();
}
?>
