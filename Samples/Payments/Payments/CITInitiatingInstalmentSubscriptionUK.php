...
function CITInitiatingInstalmentSubscriptionUK()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nCITInitiatingInstalmentSubscriptionUK Sample Code is Running..." . PHP_EOL;
    CITInitiatingInstalmentSubscriptionUK();
}
?>