...
function SaleUsingEMVTechnologyWithContactlessForAcquirer()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nSaleUsingEMVTechnologyWithContactlessForAcquirer Sample Code is Running..." . PHP_EOL;
	SaleUsingEMVTechnologyWithContactlessForAcquirer();
}
?>
