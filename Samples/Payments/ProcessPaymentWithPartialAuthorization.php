...
function ProcessPaymentWithPartialAuthorization()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nProcessPaymentWithPartialAuthorization Sample Code is Running..." . PHP_EOL;
	ProcessPaymentWithPartialAuthorization();
}
?>
