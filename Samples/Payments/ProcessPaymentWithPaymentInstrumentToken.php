...
function ProcessPaymentWithPaymentInstrumentToken()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')){
	echo "\nProcessPaymentWithPaymentInstrumentToken Sample Code is Running..." . PHP_EOL;
	ProcessPaymentWithPaymentInstrumentToken();
}
?>
