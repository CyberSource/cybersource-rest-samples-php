...
function EnrollWithTravelInformation($flag)
{
  ...
  $legArr = [
      "destination" => "RESD",
      "carrierCode" => "AS",
      "departureDate" => "2019-09-21"
  ];
  $legs = new CyberSource\Model\Riskv1authenticationsTravelInformationLegs($legArr);
  
  $passengerArr = [
      "firstName" => "Potter",
      "lastName" => "Suhember"
  ];
  $passengers = new CyberSource\Model\Riskv1authenticationsTravelInformationPassengers($passengerArr);
  ...
  $travel_information = new CyberSource\Model\Riskv1authenticationsTravelInformation($travelInfoArr);
...
if(!defined('DO_NOT_RUN_SAMPLES')){
  ...
  EnrollWithTravelInformation(false);
}
